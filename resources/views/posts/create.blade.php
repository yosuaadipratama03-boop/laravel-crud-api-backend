...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-sm text-gray-600">Bagikan ide dan cerita Anda dengan komunitas</p>
    </div>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('posts.store') }}" class="bg-white shadow-lg rounded-xl p-8 border border-gray-200">
        @csrf
        ...
        <div class="mb-6">
            ...
            <p class="mt-2 text-sm text-gray-500">Minimal 10 karakter, maksimal 5000 karakter</p>
        </div>
